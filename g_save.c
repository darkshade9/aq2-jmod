...
void InitGame (void)
{
	...
	char *grav="\0";
		...
		//KBJump - PaTMaN
//KBJump-UnComment//		kbjump = gi.cvar ("kbjump", "0", CVAR_SERVERINFO | CVAR_LATCH);
...
//        fraglimit = gi.cvar ("fraglimit", "0", CVAR_SERVERINFO); //V1.21 REMOVED
        timelimit = gi.cvar ("timelimit", "0", CVAR_SERVERINFO);
        password = gi.cvar ("password", "", CVAR_USERINFO);
        filterban = gi.cvar("filterban", "1", 0);
//FIREBLADE
	needpass = gi.cvar("needpass", "0", CVAR_SERVERINFO);
//NORADIO        radiolog = gi.cvar("radiolog", "0", 0);
//PaTMaN-REMOVE_TEAMPLAY teamplay = gi.cvar ("teamplay", "0", CVAR_SERVERINFO|CVAR_LATCH);
...
//        roundlimit = gi.cvar("roundlimit", "0", CVAR_SERVERINFO); //V1.21 REMOVED
//	limchasecam = gi.cvar("limchasecam", "0", CVAR_SERVERINFO|CVAR_LATCH);
        skipmotd = gi.cvar("skipmotd", "0", 0);
//        roundtimelimit = gi.cvar("roundtimelimit", "0", CVAR_SERVERINFO); //V1.21 REMOVED
//		maxteamkills = gi.cvar("maxteamkills", "0", 0); //V1.21 REMOVED
//		twbanrounds = gi.cvar("twbanrounds", "2", 0); //V1.21 REMOVED
//		tkbanrounds = gi.cvar("tkbanrounds", "2", 0); //V1.21 REMOVED
//        noscore = gi.cvar("noscore", "0", CVAR_SERVERINFO|CVAR_LATCH); //V1.21 REMOVED
        actionversion = gi.cvar("actionversion", "none set", CVAR_SERVERINFO|CVAR_LATCH);
        gi.cvar_set("actionversion", ACTION_VERSION);
        jmodversion = gi.cvar("jmodversion", "none set", CVAR_SERVERINFO|CVAR_LATCH);
		gi.cvar_set("jmodversion", JMOD_VERSION JMOD_REVISION);
//FIREBLADE
...
//FIREBLADE
*/  //V1.21 REMOVED
//        unique_items = gi.cvar("items", "1", CVAR_SERVERINFO|CVAR_LATCH); //V1.21 REMOVED
// zucc changed ir to 1, enabled        

                ir = gi.cvar("ir", "1", CVAR_SERVERINFO);
        knifelimit = gi.cvar ("knifelimit", "10", 0);
        markerlimit = gi.cvar ("markerlimit", "100", 0);
        traillimit = gi.cvar ("traillimit", "100", 0);
//        allweapon = gi.cvar ("allweapon", "0", CVAR_SERVERINFO); //V1.21 REMOVED
//        allitem = gi.cvar ("allitem", "0", CVAR_SERVERINFO); //V1.21 REMOVED
//        tgren = gi.cvar ("tgren", "0", CVAR_SERVERINFO);
		...
		//JMod puppet demo
		maxpuppetdemolength = gi.cvar ("maxpuppetdemolength", "30", 0);
		puppetdemosmoothing = gi.cvar ("puppetdemosmoothing", "1", 0);

		//JMod map voting
		mapvoting = gi.cvar ("mapvoting", "1", 0);
		mapvotingtime = gi.cvar ("mapvotingtime", "15", 0);
		mapvotingpercent = gi.cvar ("mapvotingpercent", "50", 0);

		//JMod misc
		notelefx = gi.cvar ("notelefx", "1", 0);
