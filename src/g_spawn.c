...
//PaTMaN - NO ITEMSvoid SP_item_health (edict_t *self);
//PaTMaN - NO ITEMSvoid SP_item_health_small (edict_t *self);
//PaTMaN - NO ITEMSvoid SP_item_health_large (edict_t *self);
//PaTMaN - NO ITEMSvoid SP_item_health_mega (edict_t *self);
...
spawn_t spawns[] = {
//PaTMaN - NO ITEMS        {"item_health", SP_item_health},
//PaTMaN - NO ITEMS        {"item_health_small", SP_item_health_small},
//PaTMaN - NO ITEMS        {"item_health_large", SP_item_health_large},
//PaTMaN - NO ITEMS        {"item_health_mega", SP_item_health_mega},
...
//FIREBLADE
                ...
                //        }
					   //KBJump - PaTMaN
//KBJump-UnComment//					   if (kbjump->value)
					//	   if (item->flags == IT_WEAPON)
//KBJump-UnComment//						   {
				//			   if (!Q_stricmp(item->classname,"weapon_railgun"))
//KBJump-UnComment//								   SpawnItem (ent,item);
//KBJump-UnComment//							   gi.dprintf ("DEBUG: 1: %s\n", ent->classname);
//KBJump-UnComment//						   }
...
//KBJump-UnComment//                else if (!kbjump->value)
                {
                        CheckItem(ent, item);
                }
        }
...
//KBJump-UnComment//		 gi.dprintf("Found %s\nReplaced with\n",ent->classname);
        //KBJump - PaTMaN - NO MODDED
		//This is where the normal q2 weapons get switched from above char array
...
//FIREBLADE                     
            //KBJump-UnComment//            if (!teamplay->value)
            //KBJump-UnComment//            {
//FIREBLADE
             //KBJump-UnComment//                   SpawnItem(ent,item);
            //KBJump-UnComment//            }
...
//FIREBLADE
    /*    if (!teamplay->value)
        {
				return;  //PaTMaN - Prevent Item Spawning
//FIREBLADE
...
// character hug 1 off right (# of characters * -8 - 1)
// character vertical spacing (32 * Row - 30)
// pic hug 1 off right (-82)
// pic vertical spacing (32 * Row - 20)

//  Current Speed			//PaTMaN      Overwrote Frags
"if 3 "
"xr -105 "
"yt 2 "
...
/*
//  ID Viewer - Puppet addition		//PaTMaN
"if 16 "
  "xv 8 "
  "yb -58 "
  "string \"Owner:\" " //Viewing "
"endif "
*/

//  ID Viewer - Class				//PaTMaN
"if 12 "
  "xv 0 "
  "yb -66 "
  "string \"\" " //Viewing "
...
"yb -116 "
//"      num 4   8 "
"num 10 8 " // V1.21 FIX - 1.20.001.01
"xv 0 "
"yb -132 "
"string RANGE "
"endif "

// Rangefinder Bad			//PaTMaN
"if 15 "
"xv 0 "
"yb -140 "
"string \"Not walkable\" "
...
//FIREBLADE
        if (nohud->value)
		{
			gi.configstring(CS_STATUSBAR, NULLHUD);
		}
		else
			//FIREBLADE
        {
			...
			//FIREBLADE
			//               {
			//NO TEAMPLAY                        if (noscore->value && teamplay->value)
			//NO TEAMPLAY                        {
			//NO TEAMPLAY                        gi.configstring (CS_STATUSBAR, dm_noscore_statusbar);
			//NO TEAMPLAY                        }
			//NO TEAMPLAY                                else
			//NO TEAMPLAY                        {
...
/*        if (teamplay->value)
		...
		*/
//NORADIO        PrecacheRadioSounds();

        //team_round_going = 0; // V1.21 REMOVED
...
//
		...
		gi.configstring(CLASS_PLAYER, "Player");
		gi.configstring(CLASS_PUPPET, "Puppet");
		gi.configstring(CLASS_PUP, "Pup");
