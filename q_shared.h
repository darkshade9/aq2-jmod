...
//PaTMaN - Simple concept... returns a point along a vector through subdivisions
//          *        *        *        *        *
// [--------|--------|--------|--------|--------]
#define	VectorSubdivide(startp,endp,subdivisions,sub_endp_to_take,resultp) ( \
	resultp[0]=(startp[0]-(((startp[0]-endp[0])/subdivisions)*sub_endp_to_take)), \
	resultp[1]=(startp[1]-(((startp[1]-endp[1])/subdivisions)*sub_endp_to_take)), \
	resultp[2]=(startp[2]-(((startp[2]-endp[2])/subdivisions)*sub_endp_to_take))  \
)
...
//#define RF_FLOATING_MARKER		8192
...
/*
//old layout nums
#define STAT_FALLDMG					4				//PaTMaN
#define STAT_FALLDMGLAST				5				//PaTMaN
#define STAT_FALLCOUNT					3				//PaTMaN
#define STAT_SPEEDX						1				//PaTMaN
#define STAT_HIGHSPEED					2				//PaTMaN
#define STAT_FLASHES                    10              //cleared each frame, 1 = health, 2 = armor
#define STAT_HUD_RANGEFINDER            8				//PaTMaN
#define STAT_ID_VIEW                    7				//PaTMaN
#define STAT_ID_VIEW_CLASS              12				//PaTMaN
#define STAT_GRAVITY					6				//PaTMaN
#define STAT_SNIPER_ICON                9
#define	STAT_HUD_ON						11				//PaTMaN
*/

//#define STAT_FALLDMG					4				//PaTMaN
#define STAT_FALLDMGLAST				5				//PaTMaN
//#define STAT_FALLCOUNT				3				//PaTMaN
#define STAT_SPEEDX						3				//PaTMaN
#define STAT_HIGHSPEED					2				//PaTMaN
#define STAT_FLASHES                    10              //cleared each frame, 1 = health, 2 = armor
#define STAT_HUD_RANGEFINDER            8				//PaTMaN
#define STAT_ID_VIEW                    7				//PaTMaN
...
#define STAT_SNIPER_ICON                9
#define	STAT_HUD_ON						11				//PaTMaN
#define	STAT_ID_VIEW_NUM				14				//PaTMaN V1.23
//#define	STAT_ID_VIEW_SPECIAL			16				//PaTMaN V1.23 (multi-puppet)
#define	STAT_HUD_RANGEFINDER_BAD		15				//PaTMaN V1.23

//V1.23 hud toggle stuff - these put a 0 in place for stats when they are set to 1
//						   then when 0, the stats don't show up
//#define	STAT_FALLCOUNT_ZERO				24				//PaTMaN V1.23
#define	STAT_GRAVITY_ZERO				25				//PaTMaN V1.23
#define	STAT_HIGHSPEED_ZERO				26				//PaTMaN V1.23
#define	STAT_FALLDMGLAST_ZERO			27				//PaTMaN V1.23
//#define	STAT_FALLDMG_ZERO				28				//PaTMaN V1.23
#define	STAT_SPEEDX_ZERO				29				//PaTMaN V1.23

//#define STAT_AMMO                       10000
//#define STAT_HELPICON			        10001
//#define STAT_FRAGS                      10002
//#define STAT_SELECTED_ITEM              10003
//#define STAT_CLIP_ICON                  10004
//#define STAT_CLIP                       10005

//#define STAT_ITEMS_ICON                 10007
//#define STAT_WEAPONS_ICON               10008
//#define STAT_TEAM_HEADER                10009
...
#define	WB_KNIVES			32
#define	WB_AKIMBO			64
#define	WB_PISTOL			128
#define	WB_MARKER			256
#define	WB_JTRAIL			512
#define	WB_GRENADE			1024
...
#define	TG_TEAMJUMP			0x00000020
#define	TG_HUD_ID			0x00000040
#define	TG_HUD_RANGE		0x00000080
#define	TG_GRENJUMP			0x00000100
#define	TG_MFLASH			0x00000200
#define	TG_MTEXT			0x00000400
#define	TG_MARKJUMPS		0x00000800
#define	TG_MARKFALLS		0x00001000
#define	TG_IR				0x00002000
#define	TG_TRAIL			0x00004000
#define	TG_TFLASH			0x00008000
#define	TG_SHOOTABLE		0x00010000
#define	TG_PUPPETSHOOT		0x00020000
#define	TG_GRENJUMPOTHER	0x00040000

#define	TGH_NO_HUD					0x00000001
#define	TGH_NO_SPEED				0x00000002
#define	TGH_NO_HIGH_SPEED			0x00000004
#define	TGH_NO_LAST_FALL_DAMAGE		0x00000008
#define	TGH_NO_GRAVITY				0x00000010

//PaTMaN - Flags for Weapon Modes... and Other Stuff
#define	WM_KNIFE				1
#define	WM_MARKER				2
#define	WM_MK23					4
#define	WM_MP5					8
#define	WM_M4					16
#define	OS_TELEPORTING			32
#define	OS_DUCKING				64
#define	OS_PUPPET_TRANS			128
#define	OS_PUPPET_SIGHT			256
#define	OS_PUPPET_SOLID			512
#define	OS_PUPPET_SOLID_PPLAY	1024
...
#define	CLASS_NONE				0
#define	CLASS_PLAYER			(CS_GENERAL+1)
#define	CLASS_PUPPET			(CS_GENERAL+2)
#define	CLASS_PUP				(CS_GENERAL+3)
